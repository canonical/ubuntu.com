...
<a class='p-button--brand' href='/kubernetes/docs/1.31/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/docs/1.31/upgrading'>Upgrading </a>
...
[release notes]: /kubernetes/docs/release-notes#1.31
