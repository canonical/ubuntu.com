...
<div class="p-notification--caution is-inline">
  <div markdown="1" class="p-notification__content">
    ...
    <p class="p-notification__message">This trusts the AWS Integrator charm with the credentials used by Juju. You could instead provide alternate credentials via the `credentials` charm config option.</p>
  </div>
</div>
