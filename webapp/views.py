...
marketo_api = MarketoAPI(
    ...
    os.getenv("FLASK_MARKETO_API_CLIENT"),
    os.getenv("FLASK_MARKETO_API_SECRET"),
    marketo_session,
)
...
def build_tutorials_index(session, tutorials_docs):
    def tutorials_index():
        ...
        search_api_key = os.getenv("FLASK_SEARCH_API_KEY")
...
def build_sitemap_tree(exclude_paths=None):
    ...
    def serve_sitemap():
        ...
        if flask.request.method == "POST":
            expected_secret = os.getenv("FLASK_SITEMAP_SECRET")
