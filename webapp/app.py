...
blog_views = BlogViews(
    ...
    excluded_tags=[
        # fmt: off
        # Exclude articles with Canonical specific tags
        ...
        2464, 4290, 1234, 1966, 4562, 2530, 2583, 3938, 1324, 1235, 2670,
        2184, 1526, 1200, 4769, 4106, 2675, 1271, 1281, 4458, 4107, 4821,
        4617, 4307, 4483, 4288, 1277, 4822, 4823, 4427, 3878, 4824, 4489,
        1205, 4191, 3457, 3768, 4825, 4826, 1377, 1202, 1270, 2169, 2053,
        4648, 2627, 2129, 3955, 4827, 1721, 4828, 4477, 4829, 4830, 1286,
        1221, 2461, 2611, 2076, 2228, 1760, 3727, 4831, 4312, 4631, 1239,
        4530
        # fmt: on
    ],
    per_page=11,
