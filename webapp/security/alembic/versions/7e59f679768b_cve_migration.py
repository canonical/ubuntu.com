...
Revision ID: 7e59f679768b
Revises: e8760725610a
Create Date: 2020-04-01 15:18:50.857881
...
def upgrade():
    ...
    sa.Column('status_description', sa.Enum('needs_triage', 'needed', 'deferred', 'pending', 'released', 'released_esm', 'ignored', 'not_affected', 'dne', name='packagestatus'), nullable=True),
    sa.ForeignKeyConstraint(['package_id'], ['package.id'], ),
    ...
    op.add_column('cve', sa.Column('public_date_usn', sa.String(), nullable=True))
