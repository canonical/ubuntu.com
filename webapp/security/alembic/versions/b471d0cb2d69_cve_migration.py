...
Revision ID: b471d0cb2d69
Revises: e8760725610a
Create Date: 2020-04-08 20:57:10.905780
...
def upgrade():
    ...
    op.create_table('cve_package_release_status',
    sa.Column('package_id', sa.Integer(), nullable=True),
    sa.Column('package_release_status_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['package_id'], ['package.id'], ),
    sa.ForeignKeyConstraint(['package_release_status_id'], ['package_release_status.id'], )
    )
    ...
    op.add_column('cve', sa.Column('last_updated_date', sa.String(), nullable=True))
