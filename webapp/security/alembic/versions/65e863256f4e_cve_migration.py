...
Revision ID: 65e863256f4e
Revises: c2bc5f0b027d
Create Date: 2020-05-12 15:12:30.632032
...
def upgrade():
    ...
    op.create_table('package_status',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.add_column('cve', sa.Column('last_updated_date', sa.DateTime(), nullable=True))
