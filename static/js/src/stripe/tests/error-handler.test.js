...
import { contractsErrorObjects, stripeErrorObjects } from "./test-responses.js";

describe("parseForErrorObject", () => {
  describe("ua-contracts API response handling", () => {
    ...
    describe("given a price mismatch error", () => {
      it("should return an error message that guides the user to a support contact", () => {
        expect(
          parseForErrorObject(contractsErrorObjects.priceMismatch)
        ).toEqual({
          message:
  ...
  describe("Stripe response handling", () => {
    describe("given an incorrect CVC error", () => {
      it("should return an appropriate error object", () => {
    ...
    describe("given an incorrect expiry date error", () => {
      it("should return an appropriate error object", () => {
        expect(
          parseForErrorObject(stripeErrorObjects.expiryIncomplete)
        ).toEqual({
          message:
    ...
    describe("given an incorrect card number error", () => {
      it("should return an appropriate error object", () => {
        expect(
          parseForErrorObject(stripeErrorObjects.cardNumberInvalid)
        ).toEqual({
          message:
            "That card number is incorrect. Check the number and try again.",
          type: "card",
