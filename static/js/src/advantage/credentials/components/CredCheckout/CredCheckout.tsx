...
import { Action, LoginSession, Product } from "advantage/subscribe/checkout/utils/types";
...
// {"product":{"id":"uaia-essential-physical-yearly","longId":"lAEv6IVik3kqgRk2zH9cxZdRR8ylyrYPXcG_13ZPEArc","name":"Ubuntu Pro","price":{"value":50000,"currency":"USD"},"period":"yearly","productID":"uaia-essential-physical","canBeTrialled":true,"private":false,"marketplace":"canonical-ua"},"quantity":1,"action":"purchase"}
// const checkoutData = localStorage.getItem("shop-checkout-data") || "";
// const parsedCheckoutData = JSON.parse(checkoutData);
const parsedCheckoutData = { product: { id: "cue-activation-key", longId: "lAMGrt4buzUR0-faJqg-Ot6dgNLn7ubIpWiyDgOrsDCg", name: "CUE Activation Key", price: { value: "4900", currency: "USD" }, period: "monthly", productID: "cue-activation-key", canBeTrialled: false, private: "false", marketplace: "canonical-ua" }, quantity: 3, action: "purchase" };
