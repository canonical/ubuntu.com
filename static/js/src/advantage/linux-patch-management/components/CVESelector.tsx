...
const CVESelector = ({cveData, packageFilter, setPackageFilter, selectedRelease,changeSelectedRelease}: Props) => {
  return (
    <Row>
        <form className="p-form p-form--inline u-align--right">
            <div className="p-form__group">
              <label className="p-form__label" htmlFor="statusFilter">Release</label>
              <select
            ...
            <div className="p-form__group">
              <label className="p-form__label" htmlFor="packageFilter">Package</label>
              <select
