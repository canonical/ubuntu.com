...
function setUpDynamicSideNav() {
  const sideNavigationElement = document.querySelector(".p-side-navigation--raw-html");
  ...
  navigationLinks.forEach(function(link) {
    link.addEventListener("click", () => toggleDrawer(sideNavigationElement, false));
  });
  sideNavigationToggle.addEventListener("click", () => toggleDrawer(sideNavigationElement, true));
