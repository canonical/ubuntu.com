const OrganizationCla = () => (
  <fieldset>
    <legend className="p-heading--3">
      Canonical Entity Contributor Licence Agreement
    </legend>
    <p>
    ...
    <p>
      ...
      whether by contract or otherwise, (ii) ownership of fifty percent (50%) or
      more of the outstanding shares or securities which vote to elect the
    ...
    <p>
      ...
      Contribution as part of the Material; provided that this licence is
    ...
    <p>
      ...
      licence, with the right to sublicense these rights to multiple tiers of
      ...
      with the Material (and portions of such combination). This licence is
      granted only to the extent that the exercise of the licensed rights
      infringes such patent claims; and provided that this licence is
      conditioned upon compliance with Section 2.3.
    </p>
    ...
    <p>
      ...
      licence the Contribution under the terms of the licence or licences which
    ...
    <p>
      To{" "}
      <a href="https://assets.ubuntu.com/v1/31b14270-Canonical-HA-CLA-ANY-E_v1.2.pdf">
        download as a PDF
      </a>
    </p>
  </fieldset>
...
export default OrganizationCla;
