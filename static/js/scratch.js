  ...
  function state(stateChange) {
    switch(stateChange) {
      case 'open':
        ...
        var cookieNode = range.createContextualFragment('<div class="p-notification p-notification--floating cookie-policy"><p class="p-notification__response">We use cookies to improve your experience. By your continued use of this site you accept such use.<br /> This notice will disappear by itself. To change your settings please <a href="/legal/terms-and-policies/privacy-policy#cookies">see our policy</a>.</p><button class="p-icon--close js-close">Close</button></div>');
