...
class TestRoutes(VCRTestCase):
    ...
    def test_blog_date_notice(self):
        ...
        with time_machine.travel("2023-05-04"):
            # blogs more than one year old should contain "more than 1 year"
            ...
            # blogs more than three year old should
            # contain "last updated x years ago"
            ...
            # old blogs updated recently should not have a notice
            ...
            # new blogs should not have a notice
