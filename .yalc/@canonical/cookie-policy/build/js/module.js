...
var checkServiceHealth = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 10:
          ...
          console.error("Cookie service health check failed:", _context3.t0);
  ...
  return function checkServiceHealth() {
...
var setCookiesAcceptedCookie = function setCookiesAcceptedCookie(preference, localMode) {
...
var storeCookiesPreferences = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var sessionParams, preference, controlsStore, localMode, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          sessionParams = _ref.sessionParams, preference = _ref.preference, controlsStore = _ref.controlsStore, localMode = _ref.localMode;
  ...
  return function storeCookiesPreferences(_x) {
    return _ref2.apply(this, arguments);
  };
}();
...
var isReturnFromSuccessfulSession = function isReturnFromSuccessfulSession(sessionParams) {
...
var setSessionLocalMode = function setSessionLocalMode(localMode) {
  console.warn("Cookie service is unavailable. Falling back to local mode for this session.");
  sessionStorage.setItem("cookie_local_mode", "true");
};

var Notification = /*#__PURE__*/function () {
  function Notification(container, renderManager, destroyComponent, sessionParams, localMode) {
...
var Manager = /*#__PURE__*/function () {
  function Manager(container, destroyComponent, sessionParams, localMode) {
...
var cookiePolicy = function cookiePolicy() {
  ...
  var renderNotification = function renderNotification(e) {
    ...
    if (cookiePolicyContainer === null) {
      ...
      var notification = new Notification(cookiePolicyContainer, renderManager, close, sessionParams, localMode);
  ...
  var renderManager = function renderManager() {
    var manager = new Manager(cookiePolicyContainer, close, sessionParams, localMode);
